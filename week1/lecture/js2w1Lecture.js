{
  function main() {
    ...
    const pizzaSelectElem = document.getElementById('pizza-price');
    pizzaSelectElem.addEventListener('change', function(event) {
      console.log(
        'You selected a ' +
          pizzaSelectElem.options[pizzaSelectElem.selectedIndex].text +
          " pizza and the option's value is " +
          pizzaSelectElem.value
      );
    });
